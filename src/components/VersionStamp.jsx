// Tiny version stamp — injected at build time via vite.config.js.
// Lets us see at a glance whether a deploy actually picked up the
// latest code without having to dig into DevTools.
